...
export const locations: Location[] = [
  {
    ...
    description: "Jardinier professionnel a Hay Riad, Rabat. Entretien de villas, tonte de pelouse, taille de haies et nettoyage de jardins. Devis gratuit.",
  ...
  },
  {
    ...
    description: "Jardinier a Souissi, Rabat. Entretien de jardins de villas et residences, elagage, tonte et amenagement paysager. Devis gratuit sur WhatsApp.",
    ...
    details: "Le quartier Souissi est repute pour ses ambassades, ses residences haut de gamme et ses jardins luxuriants. J'interviens regulierement aupres de proprietaires exigeants qui souhaitent maintenir leurs espaces verts a un niveau d'excellence. Taille de haies de lauriers, entretien de rosiers, elagage d'oliviers centenaires : chaque jardin de Souissi a ses propres besoins.",
  ...
  },
  {
    ...
    description: "Jardinier a Agdal, Rabat. Entretien de jardins, terrasses et espaces verts pour particuliers et coproprietes. Devis gratuit.",
    ...
    details: "Le quartier Agdal est un melange de residences modernes et de maisons traditionnelles avec jardin. J'interviens aussi bien pour l'entretien de petits jardins de ville que pour les espaces verts de coproprietes. Tonte, desherbage, plantation de fleurs de saison et nettoyage de terrasses font partie de mes prestations les plus demandees dans ce quartier.",
  ...
  },
  {
    ...
    name: "Temara",
    fullName: "Temara",
    description: "Jardinier a Temara et ses environs. Entretien de jardins, taille, elagage et grand nettoyage pour villas et maisons. Devis gratuit.",
    ...
    details: "Temara se developpe rapidement avec de nouvelles zones residentielles dotees de beaux espaces verts. Le climat cotier, plus humide que Rabat centre, favorise une vegetation abondante qui necessite un entretien regulier. Je m'occupe de la tonte, du desherbage, de la taille des haies brise-vent et de l'amenagement de jardins neufs pour les nouvelles constructions.",
  ...
  },
  {
    ...
    name: "Sale",
    fullName: "Sale",
    description: "Jardinier a Sale. Entretien de jardins, pelouses, taille de haies et nettoyage pour villas et residences. Devis gratuit WhatsApp.",
    ...
    details: "Sale connait un developpement urbain important avec de nouveaux quartiers residentiels comme Sala Al Jadida et Tabriquet. Les proprietaires de villas et de maisons avec jardin font de plus en plus appel a des jardiniers professionnels pour l'entretien regulier. Je propose mes services de tonte, taille, elagage et grand nettoyage dans toute la ville de Sale.",
  ...
  },
  {
    ...
    name: "Harhoura",
    fullName: "Harhoura",
    description: "Jardinier a Harhoura, plage des Nations. Entretien de jardins de villas, tonte, elagage et amenagement paysager. Devis gratuit.",
