  ...
  return (
    <main className="min-h-screen bg-neutral-100 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-extrabold text-emerald-950 mb-8">Mentions l&eacute;gales</h1>

        <div className="bg-white rounded-2xl border border-neutral-200 p-8 space-y-8 text-neutral-700 leading-relaxed">
          <section>
            <h2 className="font-bold text-lg text-neutral-900 mb-3">&Eacute;diteur du site</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-neutral-900 mb-3">Activit&eacute;</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-neutral-900 mb-3">H&eacute;bergement</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-neutral-900 mb-3">Propri&eacute;t&eacute; intellectuelle</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-neutral-900 mb-3">Donn&eacute;es personnelles</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold text-lg text-neutral-900 mb-3">Limitation de responsabilit&eacute;</h2>
            <p>
