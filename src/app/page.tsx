    ...
    <main className="min-h-screen bg-neutral-100 font-sans text-neutral-800 pb-20 md:pb-0">
      ...
      <section className="pt-18 pb-6 px-4 md:px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2 bg-emerald-800 text-white p-8 md:p-12 rounded-[2rem] relative overflow-hidden min-h-[340px] flex flex-col justify-between">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row gap-3 mt-8">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebd5a] text-white px-6 py-3.5 rounded-2xl font-bold transition-transform active:scale-95 shadow-xl"
              >
              ...
              <a
                href={`tel:${PHONE_LINK}`}
                className="flex items-center justify-center gap-2 bg-white/15 hover:bg-white/25 text-white px-6 py-3.5 rounded-2xl font-bold backdrop-blur-sm transition-all"
              >
                <Phone size={20} />
                {PHONE_DISPLAY}
              </a>
          ...
          {/* Carte photo hero */}
          <div className="bg-white rounded-[2rem] overflow-hidden relative min-h-[280px] md:min-h-0">
            <Image
              src="/hero-garden.jpg"
      ...
      <section className="px-4 md:px-6 py-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-2 bg-white p-8 rounded-[2rem] border border-neutral-200 hover:border-emerald-200 transition-colors group">
              ...
              <h3 className="text-xl font-bold text-neutral-900 mb-2">Taille &amp; &Eacute;lagage</h3>
              <p className="text-neutral-500 leading-relaxed">Entretien minutieux de vos haies, arbustes et petits arbres fruitiers. Des coupes nettes et soign&eacute;es pour un jardin toujours beau.</p>
              <p className="mt-4 text-emerald-700 font-bold text-lg">200 - 800 DH</p>
            </div>

            {/* Entretien Pelouse */}
            <div className="bg-white p-8 rounded-[2rem] border border-neutral-200 hover:border-emerald-200 transition-colors group">
              <div className="flex items-start justify-between mb-6">
                <div className="bg-emerald-50 p-4 rounded-2xl group-hover:bg-emerald-100 transition-colors">
              ...
              <h3 className="text-lg font-bold text-neutral-900 mb-2">Entretien Pelouse</h3>
              <p className="text-neutral-500 text-sm leading-relaxed">Tonte, arrosage et d&eacute;sherbage pour un gazon parfait.</p>
              <p className="mt-4 text-emerald-700 font-bold">150 - 400 DH</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-neutral-200 hover:border-emerald-200 transition-colors group">
              ...
              <h3 className="text-lg font-bold text-neutral-900 mb-2">Grand Nettoyage</h3>
              <p className="text-neutral-500 text-sm leading-relaxed">Remise en &eacute;tat de jardins abandonn&eacute;s et &eacute;vacuation des d&eacute;chets.</p>
              <p className="mt-4 text-emerald-700 font-bold">500 - 1500 DH</p>
            </div>

            {/* Plantation — large avec image */}
            <div className="md:col-span-2 bg-emerald-50 p-8 rounded-[2rem] border border-emerald-100 hover:border-emerald-200 transition-colors group">
              <div className="flex items-start justify-between mb-6">
                <div className="bg-white p-4 rounded-2xl group-hover:shadow-sm transition-shadow">
              ...
              <h3 className="text-xl font-bold text-neutral-900 mb-2">Plantation &amp; Am&eacute;nagement</h3>
              <p className="text-neutral-600 leading-relaxed">Mise en terre de vos fleurs, plantes et cr&eacute;ation de massifs. Conception d&apos;espaces verts sur mesure pour sublimer votre ext&eacute;rieur.</p>
              <p className="mt-4 text-emerald-700 font-bold text-lg">Sur devis</p>
            </div>

            {/* Entretien mensuel — accent */}
            <div className="md:col-span-2 bg-emerald-800 text-white p-8 rounded-[2rem] relative overflow-hidden">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_80%,rgba(16,185,129,0.2),transparent_60%)]" />
              <div className="relative z-10">
                <div className="bg-white/15 p-4 rounded-2xl mb-6 w-fit backdrop-blur-sm">
                ...
                <p className="text-2xl font-extrabold">
                  &agrave; partir de 500 DH<span className="text-base font-medium text-emerald-300">/mois</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="px-4 md:px-6 py-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-neutral-500 mb-6">Un devis gratuit en 3 &eacute;tapes simples</p>
      ...
      <section className="px-4 md:px-6 py-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2 bg-white p-8 rounded-[2rem] border border-neutral-200 relative">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-neutral-900 text-sm">Fatima Z.</p>
                  <p className="text-neutral-400 text-xs">Hay Riad, Rabat</p>
                </div>
              </div>
            </div>

            <div className="bg-emerald-800 text-white p-8 rounded-[2rem] flex flex-col justify-between">
              <div>
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => <Star key={i} size={18} className="fill-amber-400 text-amber-400" />)}
                </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-neutral-200">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-neutral-900 text-sm">Amina L.</p>
                  <p className="text-neutral-400 text-xs">T&eacute;mara</p>
                </div>
              </div>
            </div>

            {/* Note de confiance */}
            <div className="md:col-span-2 bg-emerald-50 p-8 rounded-[2rem] border border-emerald-100 flex flex-col md:flex-row items-center gap-6">
              ...
              <div>
                ...
                <p className="text-neutral-600">Bas&eacute; sur +150 interventions. Chaque client re&ccedil;oit un service personnalis&eacute; et un suivi apr&egrave;s intervention.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 md:px-6 py-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-emerald-800 text-white p-8 rounded-[2rem] flex flex-col justify-center">
      ...
      <section className="px-4 md:px-6 py-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* A propos */}
          <div className="md:col-span-2 bg-white p-8 md:p-10 rounded-[2rem] border border-neutral-200">
          ...
          {/* CTA carte */}
          <div className="bg-[#25D366] text-white p-8 rounded-[2rem] flex flex-col justify-between">
            <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-white text-emerald-800 px-6 py-3.5 rounded-2xl font-bold transition-transform active:scale-95 hover:bg-neutral-100"
            >
              Ouvrir WhatsApp
            </a>
          </div>
      ...
      {/* ===== FOOTER ===== */}
      <footer className="bg-neutral-950 text-white mt-6 py-12 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            ...
            <div>
              <p className="font-bold text-sm mb-3 text-neutral-300">Zones d&apos;intervention</p>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <Link key={z.slug} href={`/jardinier-${z.slug}`} className="bg-neutral-800 text-neutral-300 hover:text-white hover:bg-neutral-700 px-3 py-1 rounded-lg text-xs transition-colors">{z.name}</Link>
                ))}
              </div>
            </div>
            <div>
              <p className="font-bold text-sm mb-3 text-neutral-300">Contact</p>
              <div className="space-y-2">
                <a href={`tel:${PHONE_LINK}`} className="flex items-center gap-2 text-neutral-400 hover:text-white text-sm transition-colors">
                  <Phone size={14} /> {PHONE_DISPLAY}
                </a>
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-neutral-400 hover:text-[#25D366] text-sm transition-colors">
                  <MessageCircle size={14} /> WhatsApp
                </a>
              </div>
            </div>
          </div>
          <div className="border-t border-neutral-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-neutral-600 text-xs">
            <p>&copy; {new Date().getFullYear()} {GARDENER_NAME} &mdash; Jardinier Rabat</p>
            <a href="/mentions-legales" className="hover:text-neutral-400 underline">Mentions l&eacute;gales</a>
          </div>
        </div>
      </footer>
...
function BentoStat({ value, label, accent }: { value: string; label: string; accent?: boolean }) {
  return (
    <div className={`p-6 rounded-[1.5rem] text-center ${accent ? 'bg-emerald-800 text-white' : 'bg-white border border-neutral-200'}`}>
      <p className={`text-2xl md:text-3xl font-extrabold ${accent ? 'text-white' : 'text-emerald-700'}`}>{value}</p>
      <p className={`text-sm mt-1 ${accent ? 'text-emerald-200' : 'text-neutral-500'}`}>{label}</p>
    </div>
  );
}
...
function StepCard({ num, icon, title, desc }: { num: number; icon: React.ReactNode; title: string; desc: string }) {
  return (
    <div className="bg-white p-8 rounded-[2rem] border border-neutral-200 relative">
      <div className="absolute top-6 right-6 text-4xl font-extrabold text-neutral-100">{`0${num}`}</div>
...
function FaqItem({ question, answer }: { question: string; answer: string }) {
  return (
    <details className="group bg-white rounded-2xl border border-neutral-200 overflow-hidden">
      <summary className="flex items-center justify-between cursor-pointer p-5 font-semibold text-neutral-900 hover:bg-emerald-50/50 transition-colors">
        {question}
        <ChevronDown size={20} className="text-neutral-400 group-open:rotate-180 transition-transform shrink-0 ml-4" />
      </summary>
      <p className="px-5 pb-5 text-neutral-600 leading-relaxed">{answer}</p>
    </details>
  );
}
